class AccountProfModel {
  List<AccountProfItem>? dynamicList;
  int? numberofrecords;

  AccountProfModel({this.dynamicList, this.numberofrecords});

  AccountProfModel.fromJson(Map<String, dynamic> json) {
    if (json['dynamicList'] != null) {
      dynamicList = <AccountProfItem>[];
      json['dynamicList'].forEach((v) {
        dynamicList!.add(AccountProfItem.fromJson(v));
      });
    }
...
class AccountProfItem {
  ...
  AccountProfItem.fromJson(Map<String, dynamic> json) {
    eMID = json['EMID'];

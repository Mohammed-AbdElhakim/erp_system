...
class CustomTableAccountProf extends StatefulWidget {
  const CustomTableAccountProf({
    super.key,
  ...
  final List<AccountProfItem> listData;
  final List<ColumnList> listColumn;
  final List<AllDropdownModel> allDropdownModelList;
  final Widget paginationWidget;

  @override
  State<CustomTableAccountProf> createState() => _CustomTableAccountProfState();
}

class _CustomTableAccountProfState extends State<CustomTableAccountProf> {
...
class TableDataSource extends DataGridSource {
  ...
  final List<AccountProfItem> data;
  final Pages pageData;
  final List<AllDropdownModel> allDropdownModelList;
  final String? lang;
  TableDataSource({

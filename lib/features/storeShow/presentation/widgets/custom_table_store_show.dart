...
class CustomTableStoreShow extends StatefulWidget {
  const CustomTableStoreShow({
    super.key,
  ...
  final List<StoreShowItem> listData;
  final List<ColumnList> listColumn;
  final List<AllDropdownModel> allDropdownModelList;
  final Widget paginationWidget;

  @override
  State<CustomTableStoreShow> createState() => _CustomTableStoreShowState();
}

class _CustomTableStoreShowState extends State<CustomTableStoreShow> {

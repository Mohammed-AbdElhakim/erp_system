...
import '../models/store_show_model.dart';
import 'store_show_repo.dart';

class StoreShowRepoImpl implements StoreShowRepo {
  ...
  Future<Either<Failure, StoreShowModel>> getTableStoreShow(
    ...
    try {
      ...
      StoreShowModel storeShowModel = StoreShowModel.fromJson(data);

      return right(storeShowModel);
    } catch (e) {
      if (e is DioException) {
        return left(
          ServerFailure.fromDioException(e),

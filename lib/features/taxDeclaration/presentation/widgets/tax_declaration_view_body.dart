...
import '../manager/taxDeclaration/tax_declaration_cubit.dart';
import '../views/tax_declaration_view.dart';
import 'build_alert_add_in_dropdown.dart';
import 'custom_table_tax_declaration.dart';
import 'pagination_widget.dart';
import 'tabs_widget.dart';

class TaxDeclarationViewBody extends StatefulWidget {
  const TaxDeclarationViewBody({
    super.key,
  ...
  @override
  State<TaxDeclarationViewBody> createState() => _TaxDeclarationViewBodyState();
}

class _TaxDeclarationViewBodyState extends State<TaxDeclarationViewBody> {
  ...
  void initStatePage1() {
    ...
    myAllDropdownModelList = TaxDeclarationView.myAllDropdownModelList;
  }
                  ...
                  return BlocBuilder<TaxDeclarationCubit, TaxDeclarationState>(
                    builder: (context, state) {
                      if (state is TaxDeclarationSuccess) {
                        ...
                        return CustomTableTaxDeclaration(
                          pageData: widget.pageData,
                          listData: listData!,
                          listColumn: headerList,
                          allDropdownModelList: TaxDeclarationView.myAllDropdownModelList,
                          paginationWidget: selectTab == 0 || selectTab == 3
                              ? const SizedBox()
                              : PaginationWidget(
                                  allPages: allPages,
                              ...
                              switch (index) {
                                ...
                                case 1:
                                  ...
                                  createMyData(data: {
                                    ...
                                    "OrderBy": "EDID",
                                    "IsDesc": true,
                                    "tableName": "PurchaseTaxDetailView",
                      ...
                      } else if (state is TaxDeclarationFailure) {
    ...
    try {
      ...
      CustomAlertDialog.alertWithCustomContent(
        ...
        content: BlocProvider(
          create: (context) => AddEditCubit(getIt.get<TaxDeclarationRepoImpl>()),
  ...
  String getTailConditionInCase1AndCase2() {
    String till = "";
    for (var i in widgetsData) {
      if ((i["widget"] as ColumnList).columnName == "datefrom" && i['value'] != "") {
        till = "$till EDate  >= CONVERT(DATETIME,'${i['value']}', 102) ";
      }

...
import 'supplier_customer_process_repo.dart';

class SupplierCustomerProcessRepoImpl implements SupplierCustomerProcessRepo {
  final ApiService apiService;

  SupplierCustomerProcessRepoImpl(this.apiService);
  ...
  @override
  Future<Either<Failure, Map<String, dynamic>>> getTableSupplierCustomerProcess(

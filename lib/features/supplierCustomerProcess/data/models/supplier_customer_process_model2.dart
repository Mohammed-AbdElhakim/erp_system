class SupplierCustomerProcessModel2 {
  List<DynamicList>? dynamicList;
  num? numberofrecords;

  SupplierCustomerProcessModel2({this.dynamicList, this.numberofrecords});

  SupplierCustomerProcessModel2.fromJson(Map<String, dynamic> json) {
...
class DynamicList {
  ...
  String? acName;
  num? recivemonyCurrancy;
  String? cName;
  bool? isDefult;
  bool? isDistrib;
  String? sName;
  num? supplierCategoryId1;
  String? customerAccountName;
  num? departmentId;
  num? supplierID;
  num? extractionMasterID;
  num? customerExtractionMasterID;
  String? showPerm;
  String? addPerm;
  String? salesPerm;
  String? outPerm;
  ...
  num? detailContractId;
  num? detailCustomerId;
  String? demandId;
  num? processTypeId;
  String? processNumber;
  num? paymentTargetDetailId;
  num? customerCode;
  num? acIndex;
  String? employeeNameA;
  String? reciveEmp;
  num? shippmentOrderId;
  num? extractionID;
  num? detailPurchaseId;
  String? salesMan;
  num? safeAutoNumber;
  num? acParent;
  num? itemQuantity;
  num? constSupplierMasterId;
  bool? isNoTax;
  num? defultTaxCategoryID;
  num? taxCategoryID;

...
import '../../data/repositories/supplier_customer_process_repo_impl.dart';
...
class SupplierCustomerProcessViewBody extends StatefulWidget {
  const SupplierCustomerProcessViewBody({
    super.key,
...
class _SupplierCustomerProcessViewBodyState
  ...
  void initStatePage1() {
    ...
    myAllDropdownModelList = SupplierCustomerProcessView.myAllDropdownModelList;
  }
                  ...
                  return BlocBuilder<SupplierCustomerProcessCubit,
                    ...
                    builder: (context, state) {
                      if (state is SupplierCustomerProcessSuccess) {
                        ...
                        List<dynamic>? listData = state.dataModel.dynamicList;

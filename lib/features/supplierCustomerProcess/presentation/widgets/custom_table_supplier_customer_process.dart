...
class CustomTableSupplierCustomerProcess extends StatefulWidget {
  const CustomTableSupplierCustomerProcess({
    super.key,
  ...
  @override
  State<CustomTableSupplierCustomerProcess> createState() =>
      _CustomTableSupplierCustomerProcessState();
}

class _CustomTableSupplierCustomerProcessState
    extends State<CustomTableSupplierCustomerProcess> {

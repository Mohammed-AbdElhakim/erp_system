...
import '../widgets/supplier_customer_process_view_body.dart';

class SupplierCustomerProcessView extends StatefulWidget {
  const SupplierCustomerProcessView({super.key, required this.pageData});

...
import '../widgets/customer_account_view_body.dart';

class CustomerAccountView extends StatefulWidget {
  const CustomerAccountView({super.key, required this.pageData});
  ...
  Widget build(BuildContext context) {
    return ChangeStatusBarColor(
      child: Scaffold(
        ...
        body: BlocProvider(
          create: (context) =>
              GetAllDropdownListCubit(getIt.get<CustomerAccountRepoImpl>())
          ...
          child: BlocBuilder<GetAllDropdownListCubit, GetAllDropdownListState>(
            builder: (context, state) {
              if (state is GetAllDropdownListSuccess) {
                ...
                return BlocProvider(
                  create: (context) =>
                      GetTableCubit(getIt.get<CustomerAccountRepoImpl>())
                        ..getTable(

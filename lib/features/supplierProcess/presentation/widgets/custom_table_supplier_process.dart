...
class CustomTableSupplierProcess extends StatefulWidget {
  ...
  @override
  State<CustomTableSupplierProcess> createState() =>
      _CustomTableSupplierProcessState();
}

class _CustomTableSupplierProcessState
    extends State<CustomTableSupplierProcess> {
  ...
  // void getSelectTap() async {
  //   int tab = await Pref.getIntFromPref(key: "SELECTTAB") ?? 0;
  //   setState(() {
  //     selectTab = tab;
  //   });
  // }

...
class _PaginationWidgetState extends State<PaginationWidget> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsetsDirectional.only(bottom: widget.paddingBottom ?? 8, end: 8, start: 8),
      child: Column(
          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                InkWell(
                  onTap: (widget.myPage > 1 && widget.myPage <= widget.allPages) ? widget.onTapMin : () {},
                  child: Container(
                    width: 50,
                    alignment: Alignment.center,
                    child: Icon(
                      Icons.arrow_left,
                      color: (widget.myPage > 1 && widget.myPage <= widget.allPages) ? AppColors.blueLight : Colors.transparent,
                      size: 30,
                    ),
                  ),
                ),
                ...
                InkWell(
                  onTap: (widget.allPages > 1 && widget.myPage < widget.allPages) ? widget.onTapAdd : () {},
                  child: Container(
                    width: 50,
                    alignment: Alignment.center,
                    child: Icon(
                      Icons.arrow_right,
                      color: (widget.allPages > 1 && widget.myPage < widget.allPages) ? AppColors.blueLight : Colors.transparent,
                      size: 30,
                    ),
                  ),
                ),

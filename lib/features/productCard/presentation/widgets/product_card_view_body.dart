...
import '../manager/productCard/product_card_cubit.dart';
import '../views/product_card_view.dart';
...
class ProductCardViewBody extends StatefulWidget {
  ...
  @override
  State<ProductCardViewBody> createState() => _ProductCardViewBodyState();
}

class _ProductCardViewBodyState extends State<ProductCardViewBody> {
  ...
  void initStatePage1() {
    ...
    myAllDropdownModelList = ProductCardView.myAllDropdownModelList;
  }
    ...
    try {
      ...
      CustomAlertDialog.alertWithCustomContent(
        ...
        content: BlocProvider(
          create: (context) => AddEditCubit(getIt.get<ProductCardRepoImpl>()),
        ...
        ? BlocProvider(
            ...
            child: BlocBuilder<ProductCardCubit, ProductCardState>(
              builder: (context, state) {
                ...
                } else if (state is ProductCardFailure) {

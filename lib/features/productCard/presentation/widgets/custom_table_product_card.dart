...
class CustomTableProductCard extends StatefulWidget {
  const CustomTableProductCard({
    super.key,
  ...
  final List<ProductCardItem> listData;
  final List<ColumnList> listColumn;
  final List<AllDropdownModel> allDropdownModelList;
  final Widget paginationWidget;

  @override
  State<CustomTableProductCard> createState() => _CustomTableProductCardState();
}

class _CustomTableProductCardState extends State<CustomTableProductCard> {
...
class TableDataSource extends DataGridSource {
  ...
  final List<ProductCardItem> data;
  final Pages pageData;
  final List<AllDropdownModel> allDropdownModelList;
  final String? lang;
  TableDataSource({

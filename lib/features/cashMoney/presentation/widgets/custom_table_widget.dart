...
import 'package:erp_system/features/cashMoney/data/models/table_header_model.dart';
...
class CustomTableWidget extends StatefulWidget {
  ...
  final List<TableHeaderModel> listColumn;
...
class TableDataSource extends DataGridSource {
  ...
  DataGridRowAdapter buildRow(DataGridRow row) {
    return DataGridRowAdapter(
      ...
      TableHeaderModel columnList = listColumn
          .firstWhere((element) => ((element.enColumnLabel == e.columnName) || (element.arColumnLabel == e.columnName)));
      return Container(
        alignment: Alignment.center,
        color: data[indexRow].toJson()["Color"] != null ? hexToColor(data[indexRow].toJson()["Color"]) : null,
  ...
  buildMyWidget({
    ...
    required TableHeaderModel columnList,
  ...
  getValue(List<TableHeaderModel> listColumn, key, String value) {
    TableHeaderModel columnList = listColumn.firstWhere((element) => (element.columnName == key));
    if (columnList.insertType == "date") {
      try {
        ...
        String date = value.isNotEmpty
            ? DateFormat("yyyy-MM-dd", "en").format(DateFormat("M/d/yyyy h:mm:ss a", "en").parse(value).toLocal())
            : '';
        return date;
      }
      // String date = value.isNotEmpty

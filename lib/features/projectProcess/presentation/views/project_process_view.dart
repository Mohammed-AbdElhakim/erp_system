...
import '../widgets/project_process_view_body.dart';

class ProjectProcessView extends StatefulWidget {
  const ProjectProcessView({super.key, required this.pageData});

  final Pages pageData;
  static List<AllDropdownModel> myAllDropdownModelList = [];

  @override
  State<ProjectProcessView> createState() => _ProjectProcessViewState();
}

class _ProjectProcessViewState extends State<ProjectProcessView> {
  String? lang;

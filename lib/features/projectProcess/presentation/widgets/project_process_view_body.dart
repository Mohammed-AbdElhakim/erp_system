...
import '../../data/repositories/project_process_repo_impl.dart';
import '../manager/addEdit/add_edit_cubit.dart';
import '../manager/customerAccount/customer_account_cubit.dart';
...
class ProjectProcessViewBody extends StatefulWidget {
  const ProjectProcessViewBody({
    super.key,
  ...
  @override
  State<ProjectProcessViewBody> createState() => _ProjectProcessViewBodyState();
}

class _ProjectProcessViewBodyState extends State<ProjectProcessViewBody> {
  ...
  void initStatePage1() {
    ...
    myAllDropdownModelList = ProjectProcessView.myAllDropdownModelList;
  }

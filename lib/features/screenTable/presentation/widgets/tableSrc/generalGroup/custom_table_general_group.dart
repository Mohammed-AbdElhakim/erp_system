...
class CustomTableGeneralGroup extends StatefulWidget {
  const CustomTableGeneralGroup({
    super.key,
  ...
  @override
  State<CustomTableGeneralGroup> createState() => _CustomTableGeneralGroupState();
}

class _CustomTableGeneralGroupState extends State<CustomTableGeneralGroup> {

...
import 'custom_table_general_group.dart';

class TableGeneralGroup extends StatefulWidget {
  const TableGeneralGroup({super.key, required this.pageData});

  final Pages pageData;

  @override
  State<TableGeneralGroup> createState() => _TableGeneralGroupState();
}

class _TableGeneralGroupState extends State<TableGeneralGroup> {
  String? lang;
          ...
          return BlocBuilder<GetTableCubit, GetTableState>(
            builder: (context, state) {
              if (state is GetTableSuccess) {
                ...
                return CustomTableGeneralGroup(

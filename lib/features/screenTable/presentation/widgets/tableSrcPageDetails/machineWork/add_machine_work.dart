...
class AddMachineWork extends StatefulWidget {
  const AddMachineWork({super.key, this.tapData, required this.pageData, required this.listKey});
  ...
  @override
  State<AddMachineWork> createState() => _AddMachineWorkState();
}

class _AddMachineWorkState extends State<AddMachineWork> {
  String? lang;
  ...
  void getDataList() async {
    try {
      ...
      AddMachineWork.listMachineProcess = machineProcess['dynamicList'];
    } catch (e) {
      debugPrint(e.toString());
    }
  }

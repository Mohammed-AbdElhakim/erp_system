...
class EditMachineWork extends StatefulWidget {
  ...
  @override
  State<EditMachineWork> createState() => _EditMachineWorkState();
}

class _EditMachineWorkState extends State<EditMachineWork> {
  String? lang;
  ...
  void getDataList() async {
    try {
      ...
      EditMachineWork.listMachineProcess = machineProcess['dynamicList'];
    } catch (e) {
      debugPrint(e.toString());
    }
  }

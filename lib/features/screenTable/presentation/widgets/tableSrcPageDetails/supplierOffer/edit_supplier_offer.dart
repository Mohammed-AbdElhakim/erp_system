...
class EditSupplierOffer extends StatefulWidget {
  ...
  @override
  State<EditSupplierOffer> createState() => _EditSupplierOfferState();
}

class _EditSupplierOfferState extends State<EditSupplierOffer> {
  String? lang;
  ...
  void getDataList() async {
    try {
      ...
      EditSupplierOffer.listProduct = dataProduct['dynamicList'];
      EditSupplierOffer.listBarcodeData = barcodeData['dynamicList'];
    } catch (e) {

...
class AddSupplierOffer extends StatefulWidget {
  const AddSupplierOffer({super.key, this.tapData, required this.pageData, required this.listKey});
  ...
  @override
  State<AddSupplierOffer> createState() => _AddSupplierOfferState();
}

class _AddSupplierOfferState extends State<AddSupplierOffer> {
  String? lang;
  ...
  List<String> listHeaderSupplierOffer = [
    "الاجمالى",
    "الضريبة",
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                                    ...
                                    onTapAction: (data) {
                                      ...
                                      if (tableList.isNotEmpty) {
                                        for (var i in tableList) {
                                          salessetState(() {
                                            total =
                                                total + (double.parse(i['Quantity']) * double.parse(i['PricePerUnit'] ?? "1"));
                            ...
                            // ),
                            ...List.generate(
                                listHeaderSupplierOffer.length,
                                (index) => Container(
                                      decoration: BoxDecoration(
                                          ...
                                          Expanded(
                                            ...
                                            child: Container(
                                              ...
                                              child: getWidgetSupplyOrder(
                                                  title: listHeaderSupplierOffer[index], listSetup: listSetup),
                                            ),
                                          ),
                                        ],
                                      ),
  ...
  void getDataList() async {
    try {
      ...
      AddSupplierOffer.listProduct = dataProduct['dynamicList'];
      AddSupplierOffer.listBarcodeData = barcodeData['dynamicList'];
    } catch (e) {

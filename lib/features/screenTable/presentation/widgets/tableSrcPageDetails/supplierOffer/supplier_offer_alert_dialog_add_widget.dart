...
class SupplierOfferAlertDialogAddWidget extends StatefulWidget {
  const SupplierOfferAlertDialogAddWidget({
    super.key,
  ...
  @override
  State<SupplierOfferAlertDialogAddWidget> createState() => _SupplierOfferAlertDialogAddWidgetState();
}

class _SupplierOfferAlertDialogAddWidgetState extends State<SupplierOfferAlertDialogAddWidget> {
  String? lang;

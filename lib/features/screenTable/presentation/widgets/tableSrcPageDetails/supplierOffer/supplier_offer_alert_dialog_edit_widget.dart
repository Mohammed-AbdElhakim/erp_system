...
class SupplierOfferAlertDialogEditWidget extends StatefulWidget {
  const SupplierOfferAlertDialogEditWidget({
    super.key,
  ...
  @override
  State<SupplierOfferAlertDialogEditWidget> createState() => _SupplierOfferAlertDialogEditWidgetState();
}

class _SupplierOfferAlertDialogEditWidgetState extends State<SupplierOfferAlertDialogEditWidget> {
  String? lang;
                  ...
                  CustomButton(
                    ...
                    onTap: () {
                      if (formKey.currentState!.validate()) {
                        ...
                        if (newRowData["Quantity"] != "" || newRowData["PricePerUnit"] != "") {
                          ...
                          CustomAlertDialog.alertWithButton(
                              ...
                              desc: "سعر الوحدة و الكمية المطلوبة");
                        }
                      }
                    },
                  ),

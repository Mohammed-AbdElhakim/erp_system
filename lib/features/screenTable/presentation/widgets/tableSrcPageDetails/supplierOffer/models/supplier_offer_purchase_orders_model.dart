class SupplierOfferPurchaseOrdersModel {
  List<DynamicList>? dynamicList;
  int? numberofrecords;

  SupplierOfferPurchaseOrdersModel({this.dynamicList, this.numberofrecords});

  SupplierOfferPurchaseOrdersModel.fromJson(Map<String, dynamic> json) {

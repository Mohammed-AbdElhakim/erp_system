class SupplierOfferPurchaseRequestDetailModel {
  List<DynamicListItem>? dynamicList;
  int? numberofrecords;

  SupplierOfferPurchaseRequestDetailModel({this.dynamicList, this.numberofrecords});

  SupplierOfferPurchaseRequestDetailModel.fromJson(Map<String, dynamic> json) {

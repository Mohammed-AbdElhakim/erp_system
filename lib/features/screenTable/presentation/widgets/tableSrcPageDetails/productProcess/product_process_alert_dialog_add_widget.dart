...
class ProductProcessAlertDialogAddWidget extends StatefulWidget {
  const ProductProcessAlertDialogAddWidget({
    super.key,
  ...
  @override
  State<ProductProcessAlertDialogAddWidget> createState() => _ProductProcessAlertDialogAddWidgetState();
}

class _ProductProcessAlertDialogAddWidgetState extends State<ProductProcessAlertDialogAddWidget> {
  String? lang;

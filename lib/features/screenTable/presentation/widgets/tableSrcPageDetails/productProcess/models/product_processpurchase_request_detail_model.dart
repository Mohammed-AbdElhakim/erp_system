class ProductProcessPurchaseRequestDetailModel {
  List<DynamicListItem>? dynamicList;
  int? numberofrecords;

  ProductProcessPurchaseRequestDetailModel({this.dynamicList, this.numberofrecords});

  ProductProcessPurchaseRequestDetailModel.fromJson(Map<String, dynamic> json) {

class ProductProcessPurchaseOrdersModel {
  List<DynamicList>? dynamicList;
  int? numberofrecords;

  ProductProcessPurchaseOrdersModel({this.dynamicList, this.numberofrecords});

  ProductProcessPurchaseOrdersModel.fromJson(Map<String, dynamic> json) {

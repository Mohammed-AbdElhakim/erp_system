...
class SupplyOrderAlertDialogEditWidget extends StatefulWidget {
  const SupplyOrderAlertDialogEditWidget({
    super.key,
  ...
  @override
  State<SupplyOrderAlertDialogEditWidget> createState() => _SupplyOrderAlertDialogEditWidgetState();
}

class _SupplyOrderAlertDialogEditWidgetState extends State<SupplyOrderAlertDialogEditWidget> {
  String? lang;
                  ...
                  CustomButton(
                    ...
                    onTap: () {
                      if (formKey.currentState!.validate()) {
                        ...
                        if (newRowData["DetailValue"] != "") {
                          widget.onTapAdd(newRowData);
                          Navigator.pop(context);
                        } else {
                          CustomAlertDialog.alertWithButton(
                              context: context, type: AlertType.error, title: S.of(context).error, desc: "سعر الوحدة");
                        }
                      }
                    },
                  ),

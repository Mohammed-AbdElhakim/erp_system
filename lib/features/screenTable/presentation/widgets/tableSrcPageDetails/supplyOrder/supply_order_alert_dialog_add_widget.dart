...
class SupplyOrderAlertDialogAddWidget extends StatefulWidget {
  const SupplyOrderAlertDialogAddWidget({
    super.key,
  ...
  @override
  State<SupplyOrderAlertDialogAddWidget> createState() => _SupplyOrderAlertDialogAddWidgetState();
}

class _SupplyOrderAlertDialogAddWidgetState extends State<SupplyOrderAlertDialogAddWidget> {
  String? lang;

...
class EditShipmentOrder extends StatefulWidget {
  ...
  @override
  State<EditShipmentOrder> createState() => _EditShipmentOrderState();
}

class _EditShipmentOrderState extends State<EditShipmentOrder> {
  String? lang;
            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  if (show == false)
                    BlocBuilder<GetExpensesMasterCubit, GetExpensesMasterState>(
                      builder: (context, state) {

...
import '../manager/bills_cubit.dart';
import '../models/bills_data_model.dart';
import '../widgets/custom_table.dart';

import 'custom_table_add_edit_.dart';

class AddShipmentOrder extends StatefulWidget {
  const AddShipmentOrder({super.key, required this.pageData, this.tapData, required this.listKey});
  ...
  @override
  State<AddShipmentOrder> createState() => _AddShipmentOrderState();
}

class _AddShipmentOrderState extends State<AddShipmentOrder> {
  String? lang;
  ...
  bool show = false;
  List<BillsDataModel> originalDataList = [];
  List<BillsDataModel> filteredDataList = [];
  List<Map<String, dynamic>> listSelectRun = [];
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => BillsCubit()..getBillsTable(),
      child: BlocBuilder<BillsCubit, BillsState>(
        builder: (context, state) {
          if (state is BillsSuccess) {
            List<BillsDataModel> billsDataList = state.billsDataList;
            // حفظ البيانات الأصلية أول مرة فقط
            if (originalDataList.isEmpty) {
              originalDataList = billsDataList;
              filteredDataList = List.from(billsDataList);
            }
            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                            ...
                            SizedBox(
                              ...
                              child: Card(
                                child: Padding(
                                  ...
                                  child: Text(S.of(context).select_invoices_massage),
                                ),
                              ),
                            ),
                              ...
                              children: [
                                CustomButton(
                                  ...
                                  onTap: () {
                                    ...
                                    listSelectRun.addAll(listSelect);
                                  },
                                ),
                                CustomButton(
                  ...
                  if (show == true)
                    BlocBuilder<GetListSetupsCubit, GetListSetupsState>(
                      builder: (context, state) {
                                        ...
                                        children: [
                                          ...List.generate(categoryList.length, (index) {
                                            ...
                                            List<Widget> widgetList = getMyWidgetList(
                                                listData: listSetup, categoryName: categoryName, dataMaster: singleObject);
                  ...
                  onSaved: (newValue) {
                    if (newValue!.isNotEmpty) {
                      setState(() {
                        ...
                        //         : value);
                        dataMaster[item.columnName!.toString()] = controller.text;
                      ...
                      onTap: () async {
                        ...
                        if (dateTime != null) {
                          ...
                          dsetState(() {
                            ...
                            //         : value);
                            dataMaster[item.columnName!.toString()] = dateTime.toString();
                            singleObject = dataMaster;
                          });
                        }
                      },
              ...
              return CheckboxListTile(
                  ...
                  onChanged: (newValue) {
                    ...
                    csetState(() {
                      ...
                      //         ? value = checkboxValue
                      //         : value);
                      dataMaster[item.columnName!.toString()] = checkboxValue;
                      singleObject = dataMaster;
                    });
                  });
            },

...
class ProductionProseccTableAddEdit extends StatefulWidget {
  const ProductionProseccTableAddEdit({
    super.key,
  ...
  @override
  State<ProductionProseccTableAddEdit> createState() =>
      _ProductionProseccTableAddEditState();
}

class _ProductionProseccTableAddEditState
    extends State<ProductionProseccTableAddEdit> {
            ...
            IconButton(
              onPressed: () {
                showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      content: ProductionProseccAlertDialogAddWidget(
              ...
              onPressed: () {
                if (indexSelect != -1) {
                  showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        content: ProductionProseccAlertDialogEditWidget(
                          tapData: widget.tapData,
                          listKey: widget.listKey,
                          listHeader: widget.listHeader,
                          listColumn: widget.listColumn,

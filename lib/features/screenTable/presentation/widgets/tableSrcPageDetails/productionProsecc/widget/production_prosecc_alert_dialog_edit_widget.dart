...
class ProductionProseccAlertDialogEditWidget extends StatefulWidget {
  const ProductionProseccAlertDialogEditWidget({
    super.key,
  ...
  @override
  State<ProductionProseccAlertDialogEditWidget> createState() => _ProductionProseccAlertDialogEditWidgetState();
}

class _ProductionProseccAlertDialogEditWidgetState extends State<ProductionProseccAlertDialogEditWidget> {
  String? lang;

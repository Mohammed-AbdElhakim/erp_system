...
import 'package:erp_system/features/screenTable/presentation/widgets/tableSrcPageDetails/extractionSupplierTable/widgets/custom_container_on_tap.dart';
...
class _AddExtractionSupplierTableState
  ...
  List<Map<String, dynamic>> tableListTab1 = [];
  List<Map<String, dynamic>> tableListTab2 = [];
  List<Map<String, dynamic>> tableListTab3 = [];
  String? projectName;
                                    ...
                                    onTap: () {
                                      if (projectName == null) {
                                        CustomAlertDialog.alertWithButton(
                                            ...
                                            desc: S.of(context).choose_project);
                                      } else {
                                        showDialog(
                                          context: context,
                                          builder: (context) {
  ...
  void getDataList() async {
    try {
      ...
      AddExtractionSupplierTable.listProduct = dataProduct['dynamicList'];
    } catch (e) {

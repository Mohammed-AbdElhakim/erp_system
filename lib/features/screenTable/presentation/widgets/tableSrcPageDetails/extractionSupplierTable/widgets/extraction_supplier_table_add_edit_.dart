...
import 'extraction_supplier_alert_dialog_add_widget.dart';
import 'extraction_supplier_alert_dialog_edit_widget.dart';

typedef OnTapAction<T> = void Function(T data);

class ExtractionSupplierTableAddEdit extends StatefulWidget {
  const ExtractionSupplierTableAddEdit({
    super.key,
  ...
  @override
  State<ExtractionSupplierTableAddEdit> createState() =>
      _ExtractionSupplierTableAddEditState();
}

class _ExtractionSupplierTableAddEditState
    extends State<ExtractionSupplierTableAddEdit> {
            ...
            IconButton(
              onPressed: () {
                showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      content: ExtractionSupplierAlertDialogAddWidget(
              ...
              onPressed: () {
                if (indexSelect != -1) {
                  showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        content: ExtractionSupplierAlertDialogEditWidget(
                          typeView: widget.typeView,
                          tapData: widget.tapData,
                          listKey: widget.listKey,
                          listHeader: widget.listHeader,

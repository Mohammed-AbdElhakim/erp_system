...
class ExtractionSupplierAlertDialogAddWidget extends StatefulWidget {
  const ExtractionSupplierAlertDialogAddWidget({
    super.key,
  ...
  @override
  State<ExtractionSupplierAlertDialogAddWidget> createState() => _ExtractionSupplierAlertDialogAddWidgetState();
}

class _ExtractionSupplierAlertDialogAddWidgetState extends State<ExtractionSupplierAlertDialogAddWidget> {
  String? lang;
  ...
  void initState() {
    for (var i in widget.listColumn) {
      if (i.insertType == "checkbox") {
        widgetsData.add(WidgetsData(i, false));
      } else {
        widgetsData.add(WidgetsData(i, ""));
      }
    }

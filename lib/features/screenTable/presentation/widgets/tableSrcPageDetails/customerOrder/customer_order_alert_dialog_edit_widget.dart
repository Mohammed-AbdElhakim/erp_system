...
class CustomerOrderAlertDialogEditWidget extends StatefulWidget {
  const CustomerOrderAlertDialogEditWidget({
    super.key,
  ...
  @override
  State<CustomerOrderAlertDialogEditWidget> createState() => _CustomerOrderAlertDialogEditWidgetState();
}

class _CustomerOrderAlertDialogEditWidgetState extends State<CustomerOrderAlertDialogEditWidget> {
  String? lang;

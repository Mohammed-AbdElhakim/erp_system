...
class ProductProcessOutAlertDialogEditWidget extends StatefulWidget {
  const ProductProcessOutAlertDialogEditWidget({
    super.key,
  ...
  @override
  State<ProductProcessOutAlertDialogEditWidget> createState() => _ProductProcessOutAlertDialogEditWidgetState();
}

class _ProductProcessOutAlertDialogEditWidgetState extends State<ProductProcessOutAlertDialogEditWidget> {
  String? lang;

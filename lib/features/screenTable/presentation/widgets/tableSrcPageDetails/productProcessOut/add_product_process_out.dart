...
class AddProductProcessOut extends StatefulWidget {
  const AddProductProcessOut({super.key, this.tapData, required this.pageData, required this.listKey});
  ...
  @override
  State<AddProductProcessOut> createState() => _AddProductProcessOutState();
}

class _AddProductProcessOutState extends State<AddProductProcessOut> {
  String? lang;
  ...
  void getDataList() async {
    try {
      ...
      AddProductProcessOut.listProduct = dataProduct['dynamicList'];
      AddProductProcessOut.listProductPrices = dataProductPrices['dynamicList'];
      AddProductProcessOut.listCustomerAccount = dataCustomerAccount['dynamicList'];
      AddProductProcessOut.listBarcodeData = barcodeData['dynamicList'];
    } catch (e) {
      debugPrint(e.toString());
    }
  }

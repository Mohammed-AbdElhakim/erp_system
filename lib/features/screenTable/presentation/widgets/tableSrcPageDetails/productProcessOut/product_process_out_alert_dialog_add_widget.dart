...
class ProductProcessOutAlertDialogAddWidget extends StatefulWidget {
  const ProductProcessOutAlertDialogAddWidget({
    super.key,
  ...
  @override
  State<ProductProcessOutAlertDialogAddWidget> createState() => _ProductProcessOutAlertDialogAddWidgetState();
}

class _ProductProcessOutAlertDialogAddWidgetState extends State<ProductProcessOutAlertDialogAddWidget> {
  String? lang;

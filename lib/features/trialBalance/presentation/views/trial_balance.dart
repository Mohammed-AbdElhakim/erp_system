...
import 'package:erp_system/features/trialBalance/presentation/manager/trialBalance/trial_balance_cubit.dart';
...
class _TrialBalanceState extends State<TrialBalance> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => TrialBalanceCubit(getIt.get<TrialBalanceRepoImpl>()),

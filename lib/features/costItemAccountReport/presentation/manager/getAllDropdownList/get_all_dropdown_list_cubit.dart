...
class GetAllDropdownListCubit extends Cubit<GetAllDropdownListState> {
  GetAllDropdownListCubit(this.costItemAccountReportRepo) : super(GetAllDropdownListInitial());
  ...
  Future<void> getAllDropdownList({
    ...
    Either<Failure, List<AllDropdownModel>> result = await costItemAccountReportRepo.getAllDropdownList(pageID: pageId);
    result.fold((failure) {

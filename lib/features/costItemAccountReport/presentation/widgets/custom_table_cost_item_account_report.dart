...
class CustomTableCostItemAccountReport extends StatefulWidget {
  const CustomTableCostItemAccountReport({
    super.key,
  ...
  @override
  State<CustomTableCostItemAccountReport> createState() => _CustomTableCostItemAccountReportState();
}

class _CustomTableCostItemAccountReportState extends State<CustomTableCostItemAccountReport> {

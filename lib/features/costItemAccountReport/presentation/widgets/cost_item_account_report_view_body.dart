...
import '../manager/costItemAccountReport/cost_item_account_report_cubit.dart';
import '../views/cost_item_account_report_view.dart';
import 'build_alert_add_in_dropdown.dart';
import 'custom_floating_action_button.dart';
import 'custom_table_cost_item_account_report.dart';
import 'pagination_widget.dart';
import 'tabs_widget.dart';

class CostItemAccountReportViewBody extends StatefulWidget {
  const CostItemAccountReportViewBody({
    super.key,
  ...
  @override
  State<CostItemAccountReportViewBody> createState() => _CostItemAccountReportViewBodyState();
}

class _CostItemAccountReportViewBodyState extends State<CostItemAccountReportViewBody> {
  ...
  void initStatePage1() {
    ...
    myAllDropdownModelList = CostItemAccountReportView.myAllDropdownModelList;
  }
  ...
  _buildPage2() {
    return myData.isNotEmpty
        ? MultiBlocProvider(
            providers: [
              BlocProvider(
                create: (context) => CostItemAccountReportCubit(getIt.get<CostItemAccountReportRepoImpl>())
                  ..getTableCostItemAccountReport(
                    selectTab: selectTab,
                    objectData: myData,
                    link: "ProfAccount",
              ...
              BlocProvider(
                create: (context) =>
                    GetHeaderTableCubit(getIt.get<CostItemAccountReportRepoImpl>())..getHeaderTable(listName: "ProfAccount"),
              ),
            ],
            child: BlocBuilder<GetHeaderTableCubit, GetHeaderTableState>(
              builder: (context, state) {
                if (state is GetHeaderTableSuccess) {
                  ...
                  return BlocBuilder<CostItemAccountReportCubit, CostItemAccountReportState>(
                    builder: (context, state) {
                      if (state is CostItemAccountReportSuccess) {
                        int? numberOfRecords = state.costItemAccountReportModel.numberofrecords;
                        List<dynamic>? listData = state.costItemAccountReportModel.dynamicList;
                        ...
                        return Scaffold(
                          ...
                          body: CustomTableCostItemAccountReport(
                            pageData: widget.pageData,
                            listData: listData!,
                            listColumn: headerList,
                            allDropdownModelList: CostItemAccountReportView.myAllDropdownModelList,
                            paginationWidget: PaginationWidget(
                              ...
                              onChangeLimit: (limit) {
                                ...
                                // createMyData();
                                BlocProvider.of<CostItemAccountReportCubit>(context).getTableCostItemAccountReport(
                                  selectTab: selectTab,
                                  link: selectTab == 0 ? "ProfAccount" : "Structure",
                                  objectData: myData,
                                  numberOfPage: numberPage,
                                ...
                                switch (index) {
                                  ...
                                  case 1:
                                    String projectID = widgetsData.firstWhere(
                                      (element) => (element['widget'] as ColumnList).columnName == "CostItemID",
                                    )['value'];
                                    ...
                                    createMyData(data: {
                                      ...
                                      "listName": "PurchaseDetialView",
                                      "tailcondition": "CostItemId= $projectID",
                                    });
                                    BlocProvider.of<GetHeaderTableCubit>(context).getHeaderTable(listName: "PurchaseDetialView");
                                    BlocProvider.of<CostItemAccountReportCubit>(context).getTableCostItemAccountReport(
                                      selectTab: selectTab,
                                      objectData: myData,
                                      link: "Structure",
                                  ...
                                  case 2:
                                    ...
                                    createMyData(data: {
                                      ...
                                      "companyname": "ComID",
                                      "IsDesc": true,
                                      "listName": "ProductionProcessView",
                                      "tableName": "ProductionProcessView",
                                      "tailcondition": "CostItemId=$projectID",
                                    });
                                    BlocProvider.of<GetHeaderTableCubit>(context)
                                        .getHeaderTable(listName: "ProductionProcessView");
                                    BlocProvider.of<CostItemAccountReportCubit>(context).getTableCostItemAccountReport(
                                      selectTab: selectTab,
                                      objectData: myData,
                                      numberOfPage: numberPage,
                                  ...
                                  case 3:
                                    ...
                                    createMyData(data: {
                                      ...
                                      "companyname": "ComID",
                                      "IsDesc": true,
                                      "listName": "SalesDetailView",
                                      "tableName": "salessystemcontract",
                                      "tailcondition": "CostCenterID=$productID",
                                    });
                                    BlocProvider.of<GetHeaderTableCubit>(context).getHeaderTable(listName: "SalesDetailView");
                                    BlocProvider.of<CostItemAccountReportCubit>(context).getTableCostItemAccountReport(
                                      selectTab: selectTab,
                                      objectData: myData,
                                      numberOfPage: numberPage,
                                  ...
                                  case 4:
                                    ...
                                    createMyData(data: {
                                      ...
                                      "companyname": "ComID",
                                      "IsDesc": true,
                                      "listName": "CurrentinventoryViewWithCostitem",
                                      "tableName": "CurrentinventoryViewWithCostitem",
                                      "tailcondition": "CIID=$productID",
                                    });
                                    BlocProvider.of<GetHeaderTableCubit>(context)
                                        .getHeaderTable(listName: "CurrentinventoryViewWithCostitem");
                                    BlocProvider.of<CostItemAccountReportCubit>(context).getTableCostItemAccountReport(
                                      selectTab: selectTab,
                                      objectData: myData,
                                      numberOfPage: numberPage,
                      ...
                      } else if (state is CostItemAccountReportFailure) {
                        return CustomErrorMassage(errorMassage: state.errorMassage);
                      } else if (state is CostItemAccountReportLoading) {
                ...
                } else if (state is GetHeaderTableFailure) {
                  return CustomErrorMassage(errorMassage: state.errorMassage);
                } else if (state is GetHeaderTableLoading) {
                  return const CustomLoadingWidget();
                } else {
                  return const SizedBox();
                }
        ...
        children: [
          ...List.generate(
            ...
            (index) {
              ...
              } else if (itemColumnList.insertType == "period") {
                return buildPeriodWidget(title, itemColumnList, widgetData);
              } else {
  ...
  Widget buildPeriodWidget(
    ...
    List<ItemDrop>? myListDrop = [
      ItemDrop(text: "All", id: "0"),
      ItemDrop(text: "To Day", id: "1"),
      ItemDrop(text: "Last Week", id: "7"),
      ItemDrop(text: "Last Month", id: "30"),
      ItemDrop(text: "Last Quarter", id: "120"),
      ItemDrop(text: "Last Year", id: "365"),
    ];
            ...
            builder: (context, dropSetState) {
              return Row(
                children: [
                  ...
                  if (itemColumnList.isMulti == false && dropValue != null)
                    InkWell(
                      onTap: () {
                        dropSetState(() {
                          widgetData['value'] = null;
    ...
    try {
      ...
      CustomAlertDialog.alertWithCustomContent(
        ...
        content: BlocProvider(
          create: (context) => AddEditCubit(getIt.get<CostItemAccountReportRepoImpl>()),

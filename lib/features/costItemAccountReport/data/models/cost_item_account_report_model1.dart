class CostItemAccountReportModel1 {
  List<DynamicList>? dynamicList;
  int? numberofrecords;

  CostItemAccountReportModel1({this.dynamicList, this.numberofrecords});

  CostItemAccountReportModel1.fromJson(Map<String, dynamic> json) {
...
class DynamicList {
  ...
  double? quntity;
  double? repurcahseQuntity;
  double? repurcasedate;
  String? proName;
  int? modality;
  double? total;
  int? pOID;

class CostItemAccountReportModel2 {
  List<DynamicList>? dynamicList;
  int? numberofrecords;

  CostItemAccountReportModel2({this.dynamicList, this.numberofrecords});

  CostItemAccountReportModel2.fromJson(Map<String, dynamic> json) {

...
//         -1;
//
//     qtyController.text = widget.dataOld[widget.listColumn[0].columnName].toString() == "null"
//         ? ''
//         : widget.dataOld[widget.listColumn[0].columnName].toString();
//     priceController.text = widget.dataOld[widget.listColumn[1].columnName].toString() == "null"
//         ? ''
//         : widget.dataOld[widget.listColumn[1].columnName].toString();
//     desController.text = widget.dataOld[widget.listColumn[2].columnName].toString() == "null"
//         ? ''
//         : widget.dataOld[widget.listColumn[2].columnName].toString();
//     numController.text = widget.dataOld[widget.listColumn[4].columnName].toString() == "null"
//         ? ''
//         : widget.dataOld[widget.listColumn[4].columnName].toString();
//     for (var i in CashierViewBody.listProduct) {
//       if (i['ProID'].toString() == widget.dataOld[widget.listColumn[3].searchName].toString()) {
//         dropValue = i['ProName'] ?? '';
//       }
//       if (i['ProID'].toString() == widget.dataOld[widget.listColumn[3].searchName].toString()) {
//         dropValue = i['ProName'] ?? '';
//       }
//       if (i['ProID'].toString() == widget.dataOld[widget.listColumn[3].columnName].toString()) {
//         dropValue = i['ProName'] ?? '';
//       }
//       if (i['ProID'].toString() == widget.dataOld[widget.listColumn[3].columnName].toString()) {
//         dropValue = i['ProName'] ?? '';
...
//                                 if (widget.dataOld.containsKey(widget.listColumn[0].columnName)) {
//                                   setState(() {
//                                     widget.dataOld.updateAll((key, value) =>
//                                         key == widget.listColumn[0].columnName!.toString() ? value = qtyController.text : value);
//                                     newRowData = widget.dataOld;
//                                   });
//                                 } else {
//                                   setState(() {
//                                     widget.dataOld[widget.listColumn[0].columnName!.toString()] = newValue;
//                                     newRowData = widget.dataOld;
//                                     // newRowData
...
//                             onSaved: (newValue) {
//                               if (newValue!.isNotEmpty) {
//                                 if (widget.dataOld.containsKey(widget.listColumn[1].columnName)) {
//                                   setState(() {
//                                     widget.dataOld.updateAll((key, value) => key == widget.listColumn[1].columnName!.toString()
...
//                                 } else {
//                                   setState(() {
//                                     widget.dataOld[widget.listColumn[1].columnName!.toString()] = newValue;
//                                     newRowData = widget.dataOld;
//                                     // newRowData
//                                     //     .addAll({item.columnName!.toString(): newValue});
//                                   });
...
//                             onSaved: (newValue) {
//                               if (newValue!.isNotEmpty) {
//                                 if (widget.dataOld.containsKey(widget.listColumn[2].columnName)) {
//                                   setState(() {
//                                     widget.dataOld.updateAll((key, value) =>
//                                         key == widget.listColumn[2].columnName!.toString() ? value = desController.text : value);
//                                     newRowData = widget.dataOld;
//                                   });
//                                 } else {
//                                   setState(() {
//                                     widget.dataOld[widget.listColumn[2].columnName!.toString()] = newValue;
//                                     newRowData = widget.dataOld;
//                                     // newRowData
//                                     //     .addAll({item.columnName!.toString(): newValue});
//                                   });
...
//                                 ? [""]
//                                 : List.generate(CashierViewBody.listProduct.length,
//                                     (index) => CashierViewBody.listProduct[index]['ProName'] ?? ''),
//                             onChanged: (value) {
//                               int proID =
//                                   CashierViewBody.listProduct.firstWhere((element) => element['ProName'] == value)['ProID'];
//                               double productPrice = CashierViewBody.listProductPrices.firstWhere(
//                                     (element) =>
//                                         element['ProductID'] == proID && element['CustomerCategoryID'] == customerCategoryID,
//                                     orElse: () => {},
//                                   )['Price'] ??
//                                   0.0;
//                               if (productPrice != 0.0) {
...
//                             onSaved: (newValue) {
//                               if (newValue!.isNotEmpty) {
//                                 if (widget.dataOld.containsKey(widget.listColumn[4].columnName)) {
//                                   setState(() {
//                                     widget.dataOld.updateAll((key, value) =>
//                                         key == widget.listColumn[4].columnName!.toString() ? value = numController.text : value);
//                                     newRowData = widget.dataOld;
//                                   });
//                                 } else {
//                                   setState(() {
//                                     widget.dataOld[widget.listColumn[4].columnName!.toString()] = newValue;
//                                     newRowData = widget.dataOld;
//                                     // newRowData
//                                     //     .addAll({item.columnName!.toString(): newValue});
//                                   });

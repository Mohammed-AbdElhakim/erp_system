...
class CustomTableCustomerCrm extends StatefulWidget {
  const CustomTableCustomerCrm({
    super.key,
  ...
  @override
  State<CustomTableCustomerCrm> createState() => _CustomTableCustomerCrmState();
}

class _CustomTableCustomerCrmState extends State<CustomTableCustomerCrm> {
      ...
      case "dropdown":
        ...
        if (columnList.columnName == columnList.searchName) {
          ...
          for (var item in allDropdownModelList) {
            if (item.listName == listTabs[tabIndex].listName) {
              listDrop = item.list;
            }
          }

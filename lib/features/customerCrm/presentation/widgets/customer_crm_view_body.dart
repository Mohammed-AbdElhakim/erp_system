...
import '../manager/customerCrm/customer_crm_cubit.dart';
import '../manager/getHeaderTable/get_header_table_cubit.dart';
import '../views/customer_crm_view.dart';
import 'build_alert_add_in_dropdown.dart';
import 'custom_table_customer_crm.dart';
import 'pagination_widget.dart';
import 'tabs_widget.dart';

class CustomerCrmViewBody extends StatefulWidget {
  const CustomerCrmViewBody({
    super.key,
  ...
  @override
  State<CustomerCrmViewBody> createState() => _CustomerCrmViewBodyState();
}

class _CustomerCrmViewBodyState extends State<CustomerCrmViewBody> {
  ...
  void initStatePage1() {
    ...
    myAllDropdownModelList = CustomerCrmView.myAllDropdownModelList;
  }
  ...
  _buildPage1() {
    ...
    for (var item in widgetsData) {
      final column = item['widget'] as ColumnList;

      // استخدام قيمة افتراضية لو مفيش categoryName أو فاضية
      final rawKey = column.categoryName;
      final key = (rawKey == null || rawKey.trim().isEmpty) ? "عام" : rawKey.trim();

      if (!groupData.containsKey(key)) {
        groupData[key] = [];
      }
      groupData[key]!.add(item);
    }
    return Padding(
          ...
          children: [
            ...groupData.entries.map((entry) {
              return Column(
                ...
                children: [
                  if (entry.key != "عام") buildCategoryName(entry),
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            ...
            createMyData(data: {
              ...
              "statment": " and CustomerAccountID = $customerId",
              "selectcolumns": "",
              "IsDepartment": false,
              "AuthorizationID": 0,
              "ViewEmployeeColumn": "",
              "OrderBy": "CustomerAccountID",
              "IsDesc": true,
              "tableName": widget.listTabs[0].tableName,
              "listName": widget.listTabs[0].listName,
            });
  ...
  _buildPage2() {
    return myData.isNotEmpty
        ? MultiBlocProvider(
            providers: [
              BlocProvider(
                create: (context) => CustomerCrmCubit(getIt.get<CustomerCrmRepoImpl>())
                  ..getTableCustomerCrm(
                    selectTab: selectTab,
                    objectData: myData,
                    link: "Structure",
              ...
              BlocProvider(
                create: (context) => GetHeaderTableCubit(getIt.get<CustomerCrmRepoImpl>())
                  ..getHeaderTable(
                    listName: widget.listTabs[0].listName!,
                  ),
              ),
            ...
            child: BlocBuilder<GetHeaderTableCubit, GetHeaderTableState>(
              builder: (context, state) {
                if (state is GetHeaderTableSuccess) {
                  ...
                  return BlocBuilder<CustomerCrmCubit, CustomerCrmState>(
                    builder: (context, state) {
                      if (state is CustomerCrmSuccess) {
                        ...
                        return CustomTableCustomerCrm(
                          tabIndex: selectTab,
                          listTabs: widget.listTabs,
                          pageData: widget.pageData,
                          listData: listData!,
                          listColumn: headerList,
                          allDropdownModelList: CustomerCrmView.myAllDropdownModelList,
                          paginationWidget: PaginationWidget(
                            ...
                            onChangeLimit: (limit) {
                              ...
                              // createMyData();
                              BlocProvider.of<CustomerCrmCubit>(context).getTableCustomerCrm(
                                selectTab: selectTab,
                                link: "Structure",
                                objectData: myData,
                                numberOfPage: numberPage,
                              ...
                              switch (index) {
                                case 0:
                                  ...
                                  BlocProvider.of<GetHeaderTableCubit>(context)
                                      .getHeaderTable(listName: widget.listTabs[0].listName!);
                                  BlocProvider.of<CustomerCrmCubit>(context).getTableCustomerCrm(
                                    selectTab: selectTab,
                                    objectData: myData,
                                    link: "Structure",
                                ...
                                case 1:
                                  ...
                                  createMyData(data: {
                                    ...
                                    "limit": dropdownValue,
                                    "offset": (numberPage * dropdownValue) - dropdownValue,
                                    "statment": " and CustomerID = $customerId",
                                    "selectcolumns": "",
                                    "IsDepartment": false,
                                    "AuthorizationID": 0,
                                    "ViewEmployeeColumn": "",
                                    "OrderBy": "ContractID",
                                    "IsDesc": true,
                                    "tableName": widget.listTabs[1].tableName,
                                    "listName": widget.listTabs[1].listName,
                                  });
                                  BlocProvider.of<GetHeaderTableCubit>(context)
                                      .getHeaderTable(listName: widget.listTabs[1].listName!);
                                  BlocProvider.of<CustomerCrmCubit>(context).getTableCustomerCrm(
                                    selectTab: selectTab,
                                    objectData: myData,
                                    link: "Structure",
                                ...
                                case 2:
                                  ...
                                  createMyData(data: {
                                    ...
                                    "limit": dropdownValue,
                                    "offset": (numberPage * dropdownValue) - dropdownValue,
                                    "statment": " and Customer = $customerId",
                                    "selectcolumns": "",
                                    "IsDepartment": false,
                                    "AuthorizationID": 0,
                                    "ViewEmployeeColumn": "",
                                    ...
                                    "companyname": "ComID",
                                    "IsDesc": true,
                                    "tableName": widget.listTabs[2].tableName,
                                    "listName": widget.listTabs[2].listName,
                                  });
                                  BlocProvider.of<GetHeaderTableCubit>(context)
                                      .getHeaderTable(listName: widget.listTabs[2].listName!);
                                  BlocProvider.of<CustomerCrmCubit>(context).getTableCustomerCrm(
                                    selectTab: selectTab,
                                    objectData: myData,
                                    numberOfPage: numberPage,
                      ...
                      } else if (state is CustomerCrmFailure) {
        ...
        children: [
          ...
          StatefulBuilder(
            builder: (context, dropSetState) {
              return SizedBox(
                height: 40,
                child: itemColumnList.isMulti == false || itemColumnList.isMulti == null
    ...
    try {
      ...
      CustomAlertDialog.alertWithCustomContent(
        ...
        content: BlocProvider(
          create: (context) => AddEditCubit(getIt.get<CustomerCrmRepoImpl>()),

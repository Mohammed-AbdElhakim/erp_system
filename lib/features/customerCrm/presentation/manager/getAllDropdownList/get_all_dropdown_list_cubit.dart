...
class GetAllDropdownListCubit extends Cubit<GetAllDropdownListState> {
  GetAllDropdownListCubit(this.customerCrmRepo) : super(GetAllDropdownListInitial());
  final CustomerCrmRepo customerCrmRepo;
  ...
  Future<void> getAllDropdownList({
    ...
    Either<Failure, List<AllDropdownModel>> result = await customerCrmRepo.getAllDropdownList(pageID: pageId);
    result.fold((failure) {
